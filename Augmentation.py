...
mfunc = 1 #是否给方法名替换随机名
mvar = 0 #是否给变量名替换随机名
mvar_rate = .35 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.fs' #后缀如Buse1.abc.java
...
def geneRandomName(maxLen):
    ...
    return ret
path = '/Users/robert/Documents/src/python/matrix/data/5more/Original/Code & Matrix/Original4/80/unreadable'
...
def generate():
  for root, dirs, files in os.walk(path):
      for f in files:
          ...
          of = open('data/output/Unreadable/' + shotname + suffix + extension, encoding='utf-8', mode='w')
          content = f.read()
          m_content = content
...
mvar_rate = .60 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.s' #后缀如Buse1.abc.java
generate()

mfunc = 1 #是否给方法名替换随机名
mvar = 1 #是否给变量名替换随机名
mvar_rate = .50 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.fsv50' #后缀如Buse1.abc.java
generate()

mfunc = 1 #是否给方法名替换随机名
mvar = 1 #是否给变量名替换随机名
mvar_rate = .40 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.fsv40' #后缀如Buse1.abc.java
generate()
...
mvar_rate = .60 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.fsv60' #后缀如Buse1.abc.java
generate()
...
mvar_rate = .60 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.sv60' #后缀如Buse1.abc.java
generate()

mfunc = 1 #是否给方法名替换随机名
mvar = 1 #是否给变量名替换随机名
mvar_rate = .65 #给百分之多少的变量名替换随机名
mspace =1 #是否随机删除空白符
suffix = '.fsv65' #后缀如Buse1.abc.java
generate()
